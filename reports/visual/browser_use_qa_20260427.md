...
- 하단 탭/상점 표면 스크린샷: `reports/visual/bottom-tab-surfaces-20260427.png`
- 360px 캡처: `reports/visual/chrome-cdp-mobile-360-20260427.png`
- 데스크톱 캡처: `reports/visual/chrome-cdp-desktop-1280-20260427.png`
- 디자인 시스템 360x800 캡처: `reports/visual/design-system-mobile-360-20260427.png`
- 디자인 시스템 데스크톱 캡처: `reports/visual/design-system-desktop-1280-20260427.png`
- 디자인 시스템 하단 탭 캡처: `reports/visual/design-system-tabs-20260427.png`
- 디자인 시스템 상점 CTA 기록: `reports/visual/design-system-shop-click-20260427.md`
...
- 2026-04-27 후속 점검에서 하단 탭 `씨앗`, `도감`, `원정`, `상점`이 패널 내용을 바꾸고 mock 상점에 `스타터 상인팩`, `월간 온실권`, `관심 있음` CTA가 표시되는 것을 확인했다.
- 2026-04-27 디자인 시스템 점검에서 `qaReset=1` 첫 세션 루프가 스타터 씨앗 선택, 탭 성장, 첫 수확, 도감 보상, 두 번째 밭 열기까지 유지되는 것을 Browser Use `iab` backend로 확인했다.
- 2026-04-27 디자인 시스템 점검에서 360x800 garden viewport에 재화/status, 플레이필드, 현재 행동 CTA, 하단 5개 탭이 한 화면에 들어오는 것을 확인했다.
- 2026-04-27 디자인 시스템 점검에서 하단 탭 `정원`, `씨앗`, `도감`, `원정`, `상점`의 선택 상태와 panel 전환을 Browser Use `iab` backend로 확인했다.
- 2026-04-27 디자인 시스템 점검에서 상점 CTA 클릭 후 URL이 유지되고, 결제/외부 이동/계정 흐름이 없으며, raw `mock` 텍스트가 화면에 노출되지 않고, 상태 패널 재렌더링 시 이벤트 카운트가 114에서 115로 1 증가하는 것을 확인했다.

# Browser Use blocker — Issue #310 연구 단서 수확 발견 연출
...
- Target session name: `🔎 #310 연구 단서 수확 발견 QA`
...
- focused Playwright: `npx playwright test --config playwright.config.ts --grep "연구 단서 수확|단서 생명체"`
- screenshot target: `reports/visual/issue-310-research-clue-harvest-reveal-393.png`

...
const rows = [
  ...
  ["운영 상황판", stepStatus("Add operator control room and playable mode", "todo"), "`docs/OPERATOR_CONTROL_ROOM.md`, `npm run check:control-room`, `npm run check:ops-live`, `npm run check:seed-ops-queue`"],

...
- 2026-04-29: 원정/상점 탭 카드 polish에서 Playwright CLI가 expedition/shop full-screen tab의 status chip, reward/mock safety card, CTA hierarchy를 확인했다: `reports/visual/p0-expedition-shop-card-polish-20260429.md`, `reports/visual/p0-expedition-shop-card-polish-expedition-393-20260429.png`, `reports/visual/p0-expedition-shop-card-polish-shop-393-20260429.png`.

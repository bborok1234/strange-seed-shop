...
| 연구 단서 씨앗 성장/수확 예고 | review | Issue #308, `items/0156-research-clue-seed-growth-preview.md`, `reports/visual/browser-use-blocker-0308-20260503.md`, `reports/visual/issue-308-research-clue-seed-growth-preview-393.png`, `src/App.tsx`, `src/styles.css`, `tests/visual/p0-mobile-game-shell.spec.ts`, PR body `reports/operations/github-bodies/pr-308-research-clue-seed-growth-preview-20260503.md` | 연구 단서 source plot 성장 중 상태가 next creature card `수확 예고`/`단서 추적 중` HUD affordance로 이어지고 focused Playwright, `check:visual`, `check:ci` 통과 후 PR publication gate로 진입 |

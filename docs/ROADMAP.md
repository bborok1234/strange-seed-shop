...
| Greenhouse expansion order v0 | active | Issue #215, `items/0114-greenhouse-expansion-order-v0.md`, Browser Use QA, `reports/visual/p0-greenhouse-expansion-order-v0-20260430.md` | 선반 정리 완료 뒤 `온실 확장 준비` 주문이 열리고, 생산 수령/납품이 다음 온실 재료 보상으로 이어짐 |

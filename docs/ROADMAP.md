...
| 작업 간식 강화 포리 버프 / 생산 속도 상승 payoff | review | Issue #300, `items/0152-snack-upgrade-worker-payoff.md`, `reports/operations/github-bodies/issue-snack-upgrade-worker-payoff-20260503.md`, branch `codex/0300-snack-upgrade-worker-payoff` | 첫 주문 보상 이후 `작업 간식 강화`가 포리 buff, 생산 속도 상승, 다음 주문 가속 문맥으로 읽히도록 plan-first로 고정함 |

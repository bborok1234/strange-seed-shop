...
| 상인 주문상자 보상 수령 HUD FX | review | Issue #330, `items/0167-merchant-crate-claim-fx.md`, `reports/visual/browser-use-blocker-0330-20260503.md`, `reports/visual/issue-330-merchant-crate-claim-fx-393.png`, `reports/operations/gate-event-0330-merchant-crate-claim-fx-20260503.md`, `reports/operations/github-bodies/pr-330-merchant-crate-claim-fx-20260503.md`, branch `codex/0330-merchant-crate-claim-fx`, `npm run check:visual` 68 passed, `npm run check:ci` pass | 포장잎 상인 수확 직후 상인 주문상자 보상 수령 CTA, crate open/claimed state, HUD resource delta, reward flyout, 다음 납품/생산 목표가 검증되어 PR publication/check/merge gate로 이동 |

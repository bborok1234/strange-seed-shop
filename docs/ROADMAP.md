...
| 연구 단서 도감 새 기록 저장 payoff | active | Issue #312, `items/0158-research-clue-album-record.md`, GitHub intake body `reports/operations/github-bodies/issue-research-clue-album-record-20260503.md`, branch `codex/0312-research-clue-album-record` | 연구 단서 발견 reveal 이후 `도감에 기록하기`가 `새 단서 기록` album highlight, `도감 기록 저장` HUD affordance, 다음 목표 전환으로 이어지고 Browser Use/visual regression evidence를 남김 |

...
| Greenhouse storage upgrade v0 | active | Issue #212, `items/0113-greenhouse-storage-upgrade-v0.md`, Browser Use QA, `reports/visual/p0-greenhouse-storage-upgrade-v0-20260430.md` | 온실 선반 납품 보상 재료가 `선반 정리` 강화로 이어지고, playfield와 다음 복귀 보상에서 `선반 보관 +20%`가 보임 |

...
| Greenhouse shelf offline bonus v0 | active | Issue #206, `items/0111-greenhouse-shelf-offline-bonus-v0.md`, Browser Use QA, `reports/visual/p0-greenhouse-shelf-offline-bonus-v0-20260430.md` | 온실 선반 납품 완료가 오프라인 복귀 보관 보너스로 이어지고, 달빛 수호자 보너스와 함께 comeback payoff로 보임 |

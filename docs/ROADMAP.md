...
| 포장잎 상인 단골 납품 follow-up order | planned | Issue #332, `items/0168-merchant-followup-order.md`, branch `codex/0332-merchant-followup-order`, body-file `reports/operations/github-bodies/issue-merchant-followup-order-20260503.md` | 상인 주문상자 보상 수령 이후 merchant follow-up order 표시, progress 증가, 납품 reward motion, 다음 목표 affordance를 393px visual QA와 PR/CI evidence로 검증한다 |

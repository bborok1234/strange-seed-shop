...
| Greenhouse shelf playfield state v0 | active | Issue #209, `items/0112-greenhouse-shelf-playfield-state-v0.md`, Browser Use QA, `reports/visual/p0-greenhouse-shelf-playfield-state-v0-20260430.md` | 복귀 보상 확인 뒤 정원 playfield order crate에 `온실 선반 납품 완료`와 `선반 보관 +10%` 상태가 남음 |

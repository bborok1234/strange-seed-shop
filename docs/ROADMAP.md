...
| Greenhouse facility unlock v0 | review | Issue #200, `items/0109-greenhouse-facility-unlock-v0.md`, Browser Use QA, `reports/visual/p0-greenhouse-facility-unlock-v0-20260430.md` | 작업대 강화가 첫 온실 설비 목표로 이어지고, 잎+재료를 써서 생산률과 장기 시설 실루엣이 보임 |

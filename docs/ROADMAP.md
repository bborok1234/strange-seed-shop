...
| Creature production roster v0 | review | Issue #194, `items/0107-creature-production-roster-v0.md`, Browser Use QA, `reports/visual/p0-creature-production-roster-v0-20260430.md` | 두 번째 생명체 발견이 생산 roster와 합산 생산량으로 화면에 드러나고, 모바일 action surface overflow 회귀 gate를 통과함 |

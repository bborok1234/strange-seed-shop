...
| Greenhouse mist condenser payoff v0 | review | Issue #242, `items/0124-greenhouse-mist-condenser-payoff-v0.md`, Browser Use QA, `reports/visual/p0-greenhouse-mist-condenser-payoff-20260501.md` | `물안개 응축 납품` 완료 뒤 playfield order crate와 production card에 `응축기 가동` / `달빛 온실 단서 +1` payoff가 남는다 |

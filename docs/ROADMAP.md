...
| 연구 단서 도감 새 기록 저장 payoff | review | Issue #312, `items/0158-research-clue-album-record.md`, `reports/visual/browser-use-blocker-0312-20260503.md`, `reports/visual/issue-312-research-clue-album-record-393.png`, `src/App.tsx`, `src/styles.css`, `tests/visual/p0-mobile-game-shell.spec.ts`, PR body `reports/operations/github-bodies/pr-312-research-clue-album-record-20260503.md` | 연구 단서 발견 reveal 이후 `도감에 기록하기`가 `새 단서 기록` album highlight, `도감 기록 저장` HUD affordance, 다음 목표 전환으로 이어지고 focused Playwright, `check:visual`, `check:ci` 통과 후 PR publication gate로 진입 |

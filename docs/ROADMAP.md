...
| Greenhouse irrigation upgrade v0 | active | Issue #224, `items/0117-greenhouse-irrigation-upgrade-v0.md`, Browser Use QA, `reports/visual/p0-greenhouse-irrigation-upgrade-v0-20260430.md` | `3번 밭 순환 납품` 보상 재료와 꽃가루가 `온실 물길` 강화로 이어지고, 자동 생산률이 오른다 |

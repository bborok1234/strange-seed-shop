...
| Expedition material workbench v0 | review | Issue #197, `items/0108-expedition-material-workbench-v0.md`, Browser Use QA, `reports/visual/p0-expedition-material-workbench-v0-20260430.md` | 원정 보상 재료가 정원 작업대 강화로 이어지고, 강화 후 자동 생산률과 카드 상세가 모바일 화면에서 보임 |

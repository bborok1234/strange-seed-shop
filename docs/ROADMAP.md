...
| Greenhouse facility order v0 | review | Issue #203, `items/0110-greenhouse-facility-order-v0.md`, Browser Use QA, `reports/visual/p0-greenhouse-facility-order-v0-20260430.md` | 온실 설비 완료가 `온실 선반 납품` 주문으로 이어지고, 생산 수령/납품 보상이 다시 재료 루프로 돌아옴 |

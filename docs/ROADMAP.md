...
| 연구 단서 씨앗 구매/심기 payoff | active | Issue #306, `items/0155-research-clue-seed-planting-payoff.md`, GitHub intake body `reports/operations/github-bodies/issue-research-clue-seed-planting-payoff-20260503.md`, branch `codex/0306-research-clue-seed-planting-payoff` | 연구 완료 후 목표 씨앗 구매/심기가 `연구 단서 씨앗` receipt, playfield seed clue state, 다음 생명체 목표 CTA로 이어지고 Browser Use/visual regression evidence를 남김 |

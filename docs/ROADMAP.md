...
| Greenhouse route supply order v0 | active | Issue #221, `items/0116-greenhouse-route-supply-order-v0.md`, Browser Use QA, `reports/visual/p0-greenhouse-route-supply-order-v0-20260430.md` | 3번 밭 개방 뒤 `3번 밭 순환 납품` 주문이 열리고, 확장된 밭 용량이 다음 생산/납품 목표로 이어진다 |

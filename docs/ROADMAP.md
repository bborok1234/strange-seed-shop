...
| Greenhouse route expansion v0 | active | Issue #218, `items/0115-greenhouse-route-expansion-v0.md`, Browser Use QA, `reports/visual/p0-greenhouse-route-expansion-v0-20260430.md` | 온실 확장 주문 보상 `재료 2`가 `온실 동선` 강화로 이어지고, 3번 밭이 playfield에 열린다 |
